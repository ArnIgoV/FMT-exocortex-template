...
Каждый репозиторий в `/Users/ingwarr/IWE/` содержит `WORKPLAN.md` в корне с текущими РП.

**Агрегация:** При создании плана дня/недели Стратег:
1. Обходит все `/Users/ingwarr/IWE/*/WORKPLAN.md`
...
```bash
for repo in $(ls /Users/ingwarr/IWE/); do
  if [ -d /Users/ingwarr/IWE/$repo/.git ]; then
    echo "=== $repo ===" && cd /Users/ingwarr/IWE/$repo && git log --oneline --since="1 week ago" 2>/dev/null
  fi
done
```
...
> **Полное описание:** `/Users/ingwarr/IWE/CLAUDE.md` секция 2.
